...
equations = [predicate.MetitEquation(py-1,var_id=1),
             predicate.MetitEquation(py,var_id=1),
             predicate.MetitEquation(px,var_id=2),
             predicate.MetitEquation(vy),
             predicate.MetitEquation(vx),
             predicate.MetitEquation(-9.8 + 0.01*vy**2),
