...
initial_state = {'d':('falling',),'c':['PY - 1<0','VY=0','VX=0','PX<0']}
...
equations = [predicate.MetitEquation(py-1),
             ...
             predicate.MetitEquation(px - 3.14/2),
             predicate.MetitEquation(px - (2*3.14+3.14/2)),
