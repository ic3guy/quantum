...
initial_state = {'d':('cont',),'c':['X1>0','X2>0',str(MetitPredicate(1.62375 + 0.62378*x2**2 - 1.2475*cos(x1)-0.75,'<'))]}
bad_state = []
...
equations = [predicate.MetitEquation(x1),
             ...
             predicate.MetitEquation(1.62375 + 0.62378*x2**2 - 1.2475*cos(x1)-0.75,is_lyapunov=True)]
