...
initial_state = {'d':('s1',),'c':['X1 - 5.25>0','X1 - 5.75<0','X2>0','X2 - 0.5<0','(X1 - 4.25)^2 + (X2 - 0.25)^2 - 0.0625>0']}
...
equations = [predicate.MetitEquation(guard_equation,var_id=2),
             ...
             predicate.MetitEquation(x1-5.74,var_id=1),
             predicate.MetitEquation(x1-0.5,var_id=1)]
